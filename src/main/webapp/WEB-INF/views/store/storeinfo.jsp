...
<h1 style="text-align: center; margin-top: 60px;">매장정보</h1>
  <div class="store-allconatiner">
    <div class="store-container">
        <img class="store-image" src="/img/test.jpg" alt="매장 사진">
        <div class="store-content">
            <div class="store-name">${ svo.s_name }</div>
            <div class="store-description">${ svo.s_cont }</div>
            <div class="store-phone">${ svo.s_phone }</div>
        </div>
