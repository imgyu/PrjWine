...
<%@include file="/WEB-INF/include/nav.jsp"%>
   ...
   <div class="event-button">
	...
	<tr>
		...
		<td><a href="/EventCont?e_idx=${admineventendlist.e_idx }" class="nav-link"><img src="/img/${admineventendlist.e_fimg}"></a></td>
		<td><a href="/EventCont?e_idx=${admineventendlist.e_idx }" class="nav-link"><img src="/img/${admineventendlist.e_bimg}"></a></td>
