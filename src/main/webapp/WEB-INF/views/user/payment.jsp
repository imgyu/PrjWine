	...
	<div class="container1">
		<div class="user-info">
			...
			<c:forEach var="user" items="${userList}">
				<p>
					<strong>이름:</strong><span id="u_name">${user.u_name }</span>
				</p>
				<p>
					<strong>주소:</strong><span id="u_address">${user.u_address }${user.u_detailAddress }</span>
				</p>
				<p>
					<strong>휴대폰:</strong><span id="u_phone">${user.u_phone }</span>
				</p>
			</c:forEach>
		</div>
		<div class="order-info">
			...
			<c:forEach var="sel" items="${selCartList}">
				<p>
					<strong>와인명:</strong><span id="w_name">${sel.w_name }</span>
				</p>
				<p>
					<strong>판매점:</strong><span id="s_name">${sel.s_name }</span>
				</p>
				<p>
					<strong>가격:</strong><span id="w_price">${sel.w_price }</span>
				</p>
				<p>
					<strong>수량:</strong><span id="c_count">${sel.c_count }</span>
				</p>
				<p>
					<strong>총가격:</strong><span id=c_allprice>${sel.c_allprice }</span>
				</p>
				<p>
					<strong>판매점번호:</strong><span id="s_no">${sel.s_no }</span>
				</p>
				<p>
					<strong>와인번호:</strong><span id="w_no">${sel.w_no }</span>
				</p>
				<p>
					<strong>장바구니번호:</strong><span id="c_idx">${sel.c_idx }</span>
				</p>
				<p>
					<strong>장바구니번호:</strong><span id="wl_idx">${sel.wl_idx }</span>
				</p>
				<p>
					<strong>와인목록:</strong><span id="w_amount">${sel.w_amount }</span>
				</p>

				<c:set var="totalPrice" value="${totalPrice + sel.c_allprice }" />
			</c:forEach>
			<p>
				<strong>주문 총액:</strong><span id="p_allprice">${totalPrice}</span>
			</p>
		</div>
