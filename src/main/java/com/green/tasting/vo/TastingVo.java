...
public class TastingVo {
	...
	public void setW_avg(int w_avg) {
		this.w_avg = w_avg;
	}
	public String getW_reviews() {
		return w_reviews;
	}
	public void setW_reviews(String w_reviews) {
		this.w_reviews = w_reviews;
	}
	...
	public String toString() {
		return "TastingVo [s_no=" + s_no + ", s_id=" + s_id + ", s_pw=" + s_pw + ", s_name=" + s_name + ", s_sn=" + s_sn
				...
				+ u_extraaddress + ", w_wineery=" + w_wineery + ", w_name=" + w_name + ", w_vintage=" + w_vintage
				+ ", w_avg=" + w_avg + ", w_reviews=" + w_reviews + ", w_location=" + w_location + ", w_image="
				+ w_image + ", w_kind=" + w_kind + ", w_amount=" + w_amount + ", w_price=" + w_price + ", wl_idx="
				+ wl_idx + "]";
	}
}
